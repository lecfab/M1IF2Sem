...
\Lem{Building recognized word from others}{lem:buildRecog}{Let $x,y\in\mathcal{L}(\mathcal{M})$, such that $C_i(x)=C_j(y)$. Let $x_{1..i}$ be the prefix of length $i$ of $x$. We the same notation we have $x_{1...i}y_{j+1...|y|}\in\mathcal{L}(\mathcal{M})$.}
\begin{proof}

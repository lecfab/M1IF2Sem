...
\Rem It is almost the same as saying that $\A$ cannot distinguish between the following distribution : $(pk, Enc(pk,m_0))$ and $(pk, Enc(pk,m_1))$.
...
\draw	[->]	(1.5,4.5)	--node[above]	{$pk$}	(4.5,4.5);
\draw	[->]	(4.5,3.5)	--node[above]	{$m_0,m_1$}		(1.5,3.5);
\draw	[->]	(1.5,2.5)	--node[above]	{$c=(g^r,m_\beta h^r)$}	(4.5,2.5);
